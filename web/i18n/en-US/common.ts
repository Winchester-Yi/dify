const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Nexify account',
    langGeniusAccountTip: 'Your Nexify account and associated user data.',
    editName: 'Edit Name',
  ...
  members: {
    ...
    invitationSentTip: 'Invitation sent, and they can sign in to Nexify to access your team data.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'The OpenAI hosting service provided by Nexify allows you to use models such as GPT-3.5. Before your trial quota is used up, you need to set up other model providers.',
  ...
  apiBasedExtension: {
    title: 'API extensions provide centralized API management, simplifying configuration for easy use across Nexify\'s applications.',
  ...
  about: {
    ...
    nowAvailable: 'Nexify {{version}} is now available.',
    latestAvailable: 'Nexify {{version}} is the latest version available.',
  },
  appMenus: {
    overview: 'Monitoring',
